...
namespace Token2
{
    public class Token2 : SmartContract
    {
        //Token setting
        [DisplayName("name")]
        public static string Name() => "Token2 Token";
        [DisplayName("symbol")]
        public static string Symbol() => "T2";
        [DisplayName("decimals")]
        public static byte Decimals() => 1;
        private const ulong factor = 1; //decided by Decimals()

        // Account setting
        public static readonly byte[] admin = "AHX1wzvdw9Yipk7E9MuLY4GGX4Ym9tHeDe".ToScriptHash();
        // public static readonly byte[] admin = {97,111,42,74,56,57,111,242,3,234,1,230,192,112,174,66,27,184,206,45};
        public static readonly byte[] BaseAccount = "AHX1wzvdw9Yipk7E9MuLY4GGX4Ym9tHeDe".ToScriptHash();
