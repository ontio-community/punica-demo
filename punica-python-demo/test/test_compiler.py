...
from obox.compile.contract_compile import OBoxCompiler


class TestCompiler(unittest.TestCase):
    def test_compile_contract(self):
        contract_path = os.path.join(os.getcwd(), 'test_file', 'oep4.py')
        ...
        with open(os.path.join(os.getcwd(), 'test_file', 'oep4.avm'), 'r') as f:
            target_avm = f.read()
        with open(os.path.join(os.getcwd(), 'test_file', 'oep4.json'), 'r') as f:
            target_abi = f.read()
    ...
    def test_generate_avm_code(self):
        path = os.path.join(os.getcwd(), 'test_file', 'oep4.py')
